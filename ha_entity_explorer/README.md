...
3.  Set your interface language (`fr` or `en`).
4.  **Start** the add-on.
5.  Check the **Log** tab to ensure everything is running correctly.
6.  Click **Open Web UI**.

## Advanced Configuration

For details on security, entity filtering, and more, check the [Full Documentation](DOCS.md).

> [!NOTE]
> If you want to run this application **outside of Home Assistant** (as a standalone Python script), please refer to the [Technical Documentation](DOCS.md#standalone-installation-non-add-on).
